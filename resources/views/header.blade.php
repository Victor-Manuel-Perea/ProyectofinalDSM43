...
<body>
  ...
  <div class="box-collapse">
    <div class="title-box-d">
      <h3 class="title-d">Fabrica de lavaderos "El Tigre"</h3>
    </div>
...
<nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" href="{{ route('indexU') }}">Inicio</a>
          </li>
            <li class="nav-item">
            <a class="nav-link" href="{{ route('blogGrid') }}">Productos</a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('contactU') }}">Contactanos</a>
          </li>
        </ul>
      <div class="nav-item">
