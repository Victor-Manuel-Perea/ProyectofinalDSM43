              ...
              <div class="col-md-7">
                <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                      <div class="form-group">
                        <input name="email" type="email" class="form-control form-control-lg form-control-a" placeholder="Correo electrónico" data-rule="email" data-msg="Por favor introduzca una dirección de correo electrónico válida">
                        <div class="validate"></div>
                      </div>
                    </div>
                    <div class="col-md-12 mb-3">
                      <div class="form-group">
                        <input type="text" name="subject" class="form-control form-control-lg form-control-a" placeholder="Tema" data-rule="minlen:4" data-msg="Ingrese al menos 8 caracteres de asunto">
                        <div class="validate"></div>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <textarea name="message" class="form-control" name="message" cols="45" rows="8" data-rule="required" data-msg="Por favor escribe algo para nosotros" placeholder="Mensaje"></textarea>
                        <div class="validate"></div>
                      </div>
                    </div>
                    <div class="col-md-12 mb-3">
                      <div class="mb-3">
                        ...
                        <div class="sent-message">Por favor escribe algo para nosotros</div>
                      </div>
                    </div>
                ...
                <div class="icon-box section-b2">
                  ...
                  <div class="icon-box-content table-cell">
                    ...
                    <div class="icon-box-content">
                      <p class="mb-1">Correo.
                        <span class="color-a">tigre-mozo@outlook.com</span>
                      </p>
                      <p class="mb-1">telefono.
                        <span class="color-a">+7221015919</span>
                      </p>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="socials-footer">
                        <ul class="list-inline">
                          <li class="list-inline-item">
                            <a href="https://www.facebook.com/tigremozo.gines" class="link-one">
                              <i class="fa fa-facebook" aria-hidden="true"></i>
                            </a>
                          </li>
                          <li class="list-inline-item">
                            <a href="+7221015919" class="link-one">
